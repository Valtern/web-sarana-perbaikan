        ...
        <form>
          <div class="grid gap-4">
            ...
            <div>
              ...
              <input type="text" name="hs-phone-number-1" id="hs-phone-number-1" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Phone Number">
            </div>

            <div>
              <label for="hs-about-contacts-1" class="sr-only">Details</label>
              <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" rows="4" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Details"></textarea>
            </div>
            
            <div>
            <label for="hs-image-upload-1" class="block text-sm font-medium text-gray-700 dark:text-neutral-400 mb-1">
                Upload Image
            </label>
            <input type="file" name="hs-image-upload-1" id="hs-image-upload-1"
                class="block w-full text-sm text-gray-700 dark:text-neutral-400
                    border border-gray-200 rounded-lg px-3 py-2
                    file:bg-transparent file:border-0 file:text-sm
                    file:text-gray-500 file:dark:text-neutral-500
