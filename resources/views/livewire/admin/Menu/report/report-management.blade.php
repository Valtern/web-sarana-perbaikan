                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div class="hs-dropdown relative inline-flex [--placement:bottom]">
                                            <button id="hs-dropdown-status-{{ $report->report_ID }}" type="button" class="hs-dropdown-toggle inline-flex justify-center items-center gap-x-2 text-xs rounded-md border border-gray-300 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white px-3 py-2">
                                            ...
                                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden z-10 mt-2 min-w-[8rem] bg-white dark:bg-neutral-800 shadow-lg rounded-lg p-2 border border-gray-200 dark:border-neutral-700" aria-labelledby="hs-dropdown-status-{{ $report->report_ID }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <button wire:click="deleteReport({{ $report->report_ID }})" onclick="return confirm('Are you sure you want to delete this report?')" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-100 text-red-800 hover:bg-red-200 focus:outline-hidden focus:bg-red-200 disabled:opacity-50 disabled:pointer-events-none dark:text-red-500 dark:bg-red-800/30 dark:hover:bg-red-800/20 dark:focus:bg-red-800/20">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
