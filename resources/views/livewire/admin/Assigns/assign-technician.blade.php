  ...
  <div class="bg-white border border-gray-200 rounded-xl shadow-2xs overflow-hidden p-4 sm:p-7 dark:bg-neutral-900 dark:border-neutral-700">
    ...
    <form wire:submit.prevent="store" class="space-y-6">
      <div>
        ...
        <select id="facility_report" wire:model="facility_report_id"  class="mt-2 block w-full py-1.5 sm:py-2 px-3 pe-9 border border-gray-200 rounded-lg 
         text-xs text-gray-300 sm:text-sm focus:border-blue-500 focus:ring-blue-500 
      ...
      <div>
        ...
        <select id="technician_select" wire:model="technician_id"  class="mt-2 block w-full py-1.5 sm:py-2 px-3 pe-9 border border-gray-200 rounded-lg 
         text-xs text-gray-300 sm:text-sm focus:border-blue-500 focus:ring-blue-500 
         disabled:opacity-50 disabled:pointer-events-none 
         dark:bg-neutral-900 dark:border-neutral-700 
         dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
      ...
      <div>
            ...
            <textarea id="notes" wire:model="notes" rows="3" class="mt-2 block w-full border border-gray-200 rounded-lg  sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"></textarea>
            </div>
    ...
    <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
      ...
      <tr class="hover:bg-gray-50 dark:hover:bg-neutral-800">
        ...
        <td class="px-6 py-3 whitespace-nowrap space-x-2">
          ...
          <button wire:click="delete({{ $repair->repair_ID }})" onclick="confirm('Are you sure you want to delete this building?') || event.stopImmediatePropagation()" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-100 text-red-800 hover:bg-red-200 focus:outline-hidden focus:bg-red-200 disabled:opacity-50 disabled:pointer-events-none dark:text-red-500 dark:bg-red-800/30 dark:hover:bg-red-800/20 dark:focus:bg-red-800/20">
            Delete
          </button>
        </td>
      </tr>
