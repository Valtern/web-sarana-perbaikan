...
<div class="bg-white dark:bg-neutral-800 shadow-md rounded-lg p-8 text-center">
  ...
  <div class="mt-4">
    ...
    <div class="mt-8 flex justify-center">
      <a href="{{ route('lecturer.report') }}" class="inline-flex items-center gap-x-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-3 px-5 rounded-md transition">
        Create New Report
